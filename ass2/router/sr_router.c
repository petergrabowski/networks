                ...
                /* TODO: do we need ntohl() below? */
                    ...
                    /* TODO: do we need ntohl() below? */
                        ...
                        fprintf(stderr, "no mac address =( queueing an arpreq\n");
                            ...
                            arpreq = sr_arpcache_queuereq(sr, best_rt->gw.s_addr, newpacket_for_ip, 
                    ...
                    /* TODO: write arpreq */
                            ...
                            sr_handle_arp_req (&(sr->cache), arpreq, new_ether_hdr->ether_shost, ETHER_ADDR_LEN,
